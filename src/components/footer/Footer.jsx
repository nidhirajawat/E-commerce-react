    ...
    <footer className='style-2'>
        <div className='footer-top dark-view padding-tb'>
            <div className='container'>
                <div className='row g-4 row-cols-sm-2 row-cols-1 justify-content-center'>
                    <div className='col'>
                        <div className='footer0item our-address'>
                                        ...
                                        <ul className='lab-ul social-icons'>
                                            {
                                                socialList.map((val, i)=> {
                                                    <li key={i}>
                                                       ...
                                                       <i className={val.iconName}>{val.text}</i></a>
                                                    </li>
                                                })
                                            }
                                        </ul>
        ...
        <div className='footer-bottom'>
            <div className='container'>
                <div className="section-wrapper">
                    <p>&copy; 2023 <Link to="/">Shop Cart</Link> Designed by <a href="/" target='_blank'>
                    XYZ</a> </p>
